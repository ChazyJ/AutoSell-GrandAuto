...
class CarDetailsActivity_admin : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_car_details_admin)
        ...
        val orderButton: Button = findViewById(R.id.item_list_button_order_change)
